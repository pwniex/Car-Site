  ...
  <div class="markaModelF">
    ...
    <div class="renklerCh">
      ...
      <div class="container4">
        ...
        <div class="col10">
          <div class="ch5">
            <h5><p style="align-items: center;">Koyu Gri</p><input type="checkbox" name="renk5" value="Koyu Gri"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch6">
            <h5><p style="align-items: center;">Mor</p><input type="checkbox" name="renk6" value="Mor"></h5>
          </div>
        </div>
      </div>
      <br>
      <div class="container4">
        <div class="col10">
          <div class="ch7">
            <h5><p style="align-items: center;">Sarı</p><input type="checkbox" name="renk7" value="Sarı"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch8">
            <h5><p style="align-items: center;">Siyah</p><input type="checkbox" name="renk8" value="Siyah"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch14">
            <h5><p style="align-items: center;">Lacivert</p><input type="checkbox" name="renk9" value="Lacivert"></h5>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="motorHacmiF" action="sonuc.php" method="get">
    ...
    <div class="motorHacmiCh">
      <div class="container8">
        <div class="col12">
          <div class="mhCh1">
            <label for="fruit1">1.0 CC</label>
            <input id="fruit1" type="checkbox" name="hacim1" value="1.0 cc">
          </div>
          <div class="mhCh2">
            <label for="fruit2">1.1 CC</label>
            <input id="fruit2" type="checkbox" name="hacim2" value="1.1 cc">
          </div>
          <div class="mhCh3">
            <label for="fruit3">1.2 CC</label>
            <input id="fruit3" type="checkbox" name="hacim3" value="1.2 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh4">
            <label for="fruit4">1.3 CC</label>
            <input id="fruit4" type="checkbox" name="hacim4" value="1.3 cc">
          </div>
          <div class="mhCh5">
            <label for="fruit5">1.4 CC</label>
            <input id="fruit5" type="checkbox" name="hacim5" value="1.4 cc">
          </div>
          <div class="mhCh"6>
            <label for="fruit6">1.5 CC</label>
            <input id="fruit6" type="checkbox" name="hacim6" value="1.5 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh7">
            <label for="fruit7">1.6 CC</label>
            <input id="fruit7" type="checkbox" name="hacim7" value="1.6 cc">
          </div>
          <div class="mhCh8">
            <label for="fruit8">1.8 CC</label>
            <input id="fruit8" type="checkbox" name="hacim8" value="1.8 cc">
          </div>
          <div class="mhCh9">
            <label for="fruit9">2.0 CC</label>
            <input id="fruit9" type="checkbox" name="hacim9" value="2.0 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh10">
            <label for="fruit10">3.0 CC</label>
            <input id="fruit10" type="checkbox" name="hacim10" value="3.0 cc">
          </div>
        
        
          <div class="mhCh11">
            <label for="fruit11">3.5 CC</label>
            <input id="fruit11" type="checkbox" name="hacim11" value="3.5 cc">
          </div>
          <div class="mhCh12">
            <label for="fruit12">3.6 CC</label>
            <input id="fruit12" type="checkbox" name="hacim12" value="3.6 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh13">
            <label for="fruit13">4.0 CC</label>
            <input id="fruit13" type="checkbox" name="hacim13" value="4.0 cc">
          </div>
          <div class="mhCh14">
            <label for="fruit14">6.0 CC</label>
            <input id="fruit14" type="checkbox" name="hacim14" value="6.0 cc">
          </div>
          <div class="mhCh15">
            <label for="fruit15">6.5 CC</label>
      ...
      <div class="container9">
        ...
        <div class="col13">
          ...
          <h5>
            ...
            <input style="position: relative; left: 60%;" id="vk4" type="checkbox" name="kapi1" value="5">
          </h5>
          <h5>
            <label for="vk5">4</label>
            <input style="position: relative; left: 60%;" id="vk5" type="checkbox" name="kapi2" value="4">
          </h5>
          <h5>
            <label for="vk6">3</label>
            <input style="position: relative; left: 60%;" id="vk6" type="checkbox" name="kapi3" value="3">

          </h5>
        </div>
      </div>
    </div>
    <input type="hidden" name="tablo" value="binek">
  </div>
  <br>
  <br>
  <br>
