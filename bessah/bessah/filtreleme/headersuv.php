...
<section style="position: relative; height: 2350px;" id="filtre">
...
<form action="filtremodel.php" method="get">
  <div class="markaModelF">
    ...
    <div class="renklerCh">
      ...
      <div class="container4">
        ...
        <div class="col10">
          <div class="ch14">
            <h5><p style="align-items: center;">Lacivert</p><input type="checkbox" name="renk6" value="Lacivert"></h5>
          </div>
        </div>
      </div>
      <br>
      <div class="container4">
        <div class="col10">
          <div class="ch11">
            <h5><p style="align-items: center;">Kahverengi</p><input type="checkbox" name="renk7" value="Kahverengi"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch12">
            <h5><p style="align-items: center;">Füme</p><input type="checkbox" name="renk8" value="Füme"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch13">
            <h5><p style="align-items: center;">Yeşil</p><input type="checkbox" name="renk9" value="Yeşil"></h5>
          </div>
        </div>
      </div>
      <br>
      <div class="container4">
        <div class="col10">
          <div class="ch5">
            <h5><p style="align-items: center;">Koyu Gri</p><input type="checkbox" name="renk10" value="Koyu Gri"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch7">
            <h5><p style="align-items: center;">Sarı</p><input type="checkbox" name="renk11" value="Sarı"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch8">
            <h5><p style="align-items: center;">Siyah</p><input type="checkbox" name="renk12" value="Siyah"></h5>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="motorHacmiF" action="sonuc.php" method="get">
    ...
    <div class="motorHacmiCh">
      <div class="container8">
        <div class="col12">
          <div class="mhCh1">
            <label for="fruit1">2.1 CC</label>
            <input id="fruit1" type="checkbox" name="hacim1" value="2.1 cc">
          </div>
          <div class="mhCh2">
            <label for="fruit2">2.5 CC</label>
            <input id="fruit2" type="checkbox" name="hacim2" value="2.5 cc">
          </div>
          <div class="mhCh3">
            <label for="fruit3">2.7 CC</label>
            <input id="fruit3" type="checkbox" name="hacim3" value="2.7 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh4">
            <label for="fruit4">2.8 CC</label>
            <input id="fruit4" type="checkbox" name="hacim4" value="2.8 cc">
          </div>
          <div class="mhCh5">
            <label for="fruit5">2.9 CC</label>
            <input id="fruit5" type="checkbox" name="hacim5" value="2.9 cc">
          </div>
          <div class="mhCh"6>
            <label for="fruit6">3.0 CC</label>
            <input id="fruit6" type="checkbox" name="hacim6" value="3.0 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh7">
            <label for="fruit7">3.2 CC</label>
            <input id="fruit7" type="checkbox" name="hacim7" value="3.2 cc">
          </div>
          <div class="mhCh8">
            <label for="fruit8">3.4 CC</label>
            <input id="fruit8" type="checkbox" name="hacim8" value="3.4 cc">
          </div>
          <div class="mhCh9">
            <label for="fruit9">3.5 CC</label>
            <input id="fruit9" type="checkbox" name="hacim9" value="3.5 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh10">
            <label for="fruit10">3.9 CC</label>
            <input id="fruit10" type="checkbox" name="hacim10" value="3.9 cc">
          </div>
          ...
          <div class="mhCh12">
            <label for="fruit12">4.3 CC</label>
            <input id="fruit12" type="checkbox" name="hacim12" value="4.3 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh13">
            <label for="fruit13">5.0 CC</label>
            <input id="fruit13" type="checkbox" name="hacim13" value="5.0 cc">
          </div>
          <div class="mhCh14">
            <label for="fruit14">5.6 CC</label>
            <input id="fruit14" type="checkbox" name="hacim14" value="5.6 cc">
          </div>
          <div class="mhCh15">
            <label for="fruit15">6.0 CC</label>
            <input id="fruit15" type="checkbox" name="hacim15" value="6.0 cc">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="vitesKapiF" action="sonuc2.php" method="get">
    ...
    <input type="hidden" name="tablo" value="suv">
  </div>
  <br>
  <br>
  <br>
