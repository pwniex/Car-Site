...
<form action="filtremodel.php" method="get">
  <div class="markaModelF">
    ...
    <div class="renklerCh">
      ...
      <div class="container4">
        <div class="col10">
          <div class="ch13">
            <h5><p style="align-items: center;">Yeşil</p><input type="checkbox" name="renk7" value="Yeşil"></h5>
          </div>
        </div>
        <div class="col10">
          <div class="ch7">
  ...
  <div class="motorHacmiF" action="sonuc.php" method="get">
    ...
    <div class="motorHacmiCh">
      <div class="container8">
        <div class="col12">
          <div class="mhCh1">
            <label for="fruit1">3.0 CC</label>
            <input id="fruit1" type="checkbox" name="hacim1" value=">3.0 CC">
          </div>
          <div class="mhCh2">
            <label for="fruit2">3.4 CC</label>
            <input id="fruit2" type="checkbox" name="hacim2" value="3.4 CC">
          </div>
          <div class="mhCh3">
            <label for="fruit3">3.5 CC</label>
            <input id="fruit3" type="checkbox" name="hacim3" value="3.5 CC">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh4">
            <label for="fruit4">3.8 CC</label>
            <input id="fruit4" type="checkbox" name="hacim4" value="3.8 cc">
          </div>
          <div class="mhCh5">
            <label for="fruit5">3.9 CC</label>
            <input id="fruit5" type="checkbox" name="hacim5" value="3.9 cc">
          </div>
          <div class="mhCh"6>
            <label for="fruit6">4.0 CC</label>
            <input id="fruit6" type="checkbox" name="hacim6" value="4.0 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh7">
            <label for="fruit7">4.6 CC</label>
            <input id="fruit7" type="checkbox" name="hacim7" value="4.6 cc">
          </div>
          <div class="mhCh8">
            <label for="fruit8">4.9 CC</label>
            <input id="fruit8" type="checkbox" name="hacim8" value="4.9 c">
          </div>
          <div class="mhCh9">
            <label for="fruit9">5.0 CC</label>
            <input id="fruit9" type="checkbox" name="hacim9" value="5.0 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh10">
            <label for="fruit10">5.2 CC</label>
            <input id="fruit10" type="checkbox" name="hacim10" value="5.2 cc">
          </div>
        
        
          <div class="mhCh11">
            <label for="fruit11">5.5 CC</label>
            <input id="fruit11" type="checkbox" name="hacim11" value="5.5 cc">
          </div>
          <div class="mhCh12">
            <label for="fruit12">5.9 CC</label>
            <input id="fruit12" type="checkbox" name="hacim12" value="5.9 cc">
          </div>
        </div>
        <div class="col12">
          <div class="mhCh13">
          ...
          <div class="mhCh14">
            <label for="fruit14">6.1 CC</label>
            <input id="fruit14" type="checkbox" name="hacim14" value="6.1 cc">
          </div>
          <div class="mhCh15">
            <label for="fruit15">6.2 CC</label>
            <input id="fruit15" type="checkbox" name="hacim15" value="6.2 cc">
          </div>
        </div>
  ...
  <div class="vitesKapiF" action="sonuc2.php" method="get">
    ...
    <input type="hidden" name="tablo" value="spor">
  </div>
  <br>
  <br>
  <br>
