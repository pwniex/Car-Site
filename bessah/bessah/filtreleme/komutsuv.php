...
//--------------------------Renk Alanı-----------------------------------//
	...
	if (isset($_GET["renk10"])) {
		$renk10=$_GET["renk10"];
	}else{
		$renk10="1";
	}

	if (isset($_GET["renk11"])) {
		$renk11=$_GET["renk11"];
	}else{
		$renk11="1";
	}

  if (isset($_GET["renk12"])) {
    $renk12=$_GET["renk12"];
  }else{
    $renk12="1";
  }

	if ($renk1=="1" && $renk2=="1" && $renk3=="1" && $renk4=="1" && $renk5=="1" && $renk6=="1" && $renk7=="1" && $renk8=="1" && $renk9=="1" && $renk10=="1" && $renk11=="1" &&$renk12=="1") {
   		$renk1="Beyaz";
   		$renk2="Gri";
   		$renk3="Kırmızı";
   		$renk4="Mavi";
...
//--------------------------Hacim Alanı-----------------------------------//
   ...
   if ($hacim1=="2" && $hacim2=="2" && $hacim3=="2" && $hacim4=="2" && $hacim5=="2" && $hacim6=="2" && $hacim7=="2" && $hacim8=="2" && $hacim9=="2" && $hacim10=="2" &&$hacim11=="2" && $hacim12=="2" && $hacim13=="2" && $hacim14=="2" && $hacim15=="2" && $hacim16=="2" && $hacim17=="2" && $hacim18=="2" && $hacim19=="2" && $hacim20=="2" && $hacim21=="2" && $hacim22=="2" && $hacim23=="2" && $hacim24=="2") {
   		$hacim1="2.1 cc";
   		$hacim2="2.5 cc";
   		$hacim3="2.7 cc";
   		$hacim4="2.8 cc";
