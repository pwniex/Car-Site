...
?>
         ...
         <div id="page-wrapper">
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-head-line">Ön Gösterim 3.Bölüm Düzenleme Ekranı</h1>


                           
                               <?php   
                                    if (isset($_GET['yolla3']) && $_GET['yolla3']=='ok') 
                                    ...
                                    elseif (isset($_GET['yolla3']) && $_GET['yolla3']=='no') 
                                    {
                                        ?> 
                            ...
                            <div class="panel-body">
                                <form role="form" action="yol.php" method="POST" autocomplete="off">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="gosterim_marka" value="<?php echo $ccc['gosteri_marka'];?>">
                                                
                                            </div>
                                            <div class="form-group">
                                                <label>Ön Gösterimde Resgilenicek Aracın Modelini Yazınız.</label>
                                                <input class="form-control" type="text" name="gosterim_model" value="<?php echo $ccc['gosteri_model'];?>">
                                     ...
                                     <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="gosterim_aciklama" value="<?php echo $ccc['gosteri_aciklama'];?>">
                                       ...
                                       <div class="radio">
                                            ...
                                            <input class="form-control" type="text" name="gosterim_resim" value="<?php echo $ccc['gosteri_resim'];?>" required="required">
                                            ...
                                            <button type="submit" class="btn btn-info" name="yol3">Güncelle</button>
